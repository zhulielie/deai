...
STYLES = {
    ...
    "perfectionist": StyleProfile(
        ...
        curse_words=["sigh", "damn"],
        todo_phrases=["TODO: refactor", "FIXME: extract", "revisit later"],
        hack_phrases=["kludge", "workaround", "temporary"],
        confessions=["overengineered", "premature abstraction", "cursed"],
    ...
    "copypaster": StyleProfile(
        ...
        curse_words=["ugly"],
        todo_phrases=["TODO: from old repo", "FIXME: adapted", "revisit original"],
        hack_phrases=["kludge", "workaround", "copied"],
        confessions=["damn", "legacy", "cursed"],
